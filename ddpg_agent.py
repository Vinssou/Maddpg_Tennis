...
class Agent():
    ...
    def __init__(self, agent_count, state_size, action_size, random_seed):
        ...
        self.critic_local = Critic(state_size, action_size, random_seed).to(device) # agent_count *
        self.critic_target = Critic(state_size, action_size, random_seed).to(device) # agent_count *
